...
namespace ISL
{
    class TeamSaves
    {
        ...
        public TeamSaves(IWebDriver driver)
        {
            this.driver = driver;
        }
        public IWebElement GetTeamSavesData()
        {
            ...
            foreach (var div in allDivs)
            {
                ...
                var teamSaves = div.FindElement(By.CssSelector(".si-goals")).Text;

                Team.Add(new Team { TeamName = teamname, TeamSaves = teamSaves });
                TestContext.Out.WriteLine($"TeamName: { teamname }| TeamSaves: { teamSaves } ");
            }
        ...
        public void CreateXlSheet(List<Team> Team)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < Team.Count; i++)
                {
                    ...
                    oSheet.Cells[row, 2] = Team[i].TeamSaves;
                }
