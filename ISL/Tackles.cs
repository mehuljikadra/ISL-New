...
namespace ISL
{
    class Tackles
    {
        ...
        public Tackles(IWebDriver driver)
        {
            this.driver = driver;
        }
        public IWebElement GetTacklesData()
        {
            ...
            foreach (var div in allDivs)
            {
                ...
                var tackles = div.FindElement(By.CssSelector(".si-plyStats-gamplyd ")).Text;

                players.Add(new players { Name = name, Id = id, Tackles = tackles });
                TestContext.Out.WriteLine($"NAME: { name }| Id:{id}|Tackles: { tackles } ");
            }
        ...
        public void CreateXlSheet(List<players> players)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < players.Count; i++)
                {
                    ...
                    oSheet.Cells[row, 3] = players[i].Tackles;
                }

                oXL.UserControl = false;
                oWB.SaveAs(@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\Tackle.xlsx", Microsoft.Office.Interop.Excel.XlFileFormat.xlWorkbookDefault, Type.Missing, Type.Missing,
                    false, false, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlNoChange,
                    Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
                oXL.Visible = true;

                string srcPath = (@"C:\Users\aditya.bhosle\Desktop\ISL\Tackles.xls");

                oWB = (excel._Workbook)(oXL.Workbooks.Open(srcPath));
                oSheet = oWB.Worksheets.get_Item(1);

                string destPath = (@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\Tackle.xlsx");
...

        {
            ...
            var tackles = driver.FindElement(By.CssSelector(".si-points span")).Text;
