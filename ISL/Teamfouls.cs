...
namespace ISL
{
    class Teamfouls
    {
        ...
        public Teamfouls(IWebDriver driver)
        {
            this.driver = driver;
        }
        public IWebElement GetTeamfoulsData()
        {
            ...
            foreach (var div in allDivs)
            {
                ...
                var teamFouls = div.FindElement(By.CssSelector(".si-goals")).Text;

                Team.Add(new Team { TeamName = teamname, TeamFouls = teamFouls });
                TestContext.Out.WriteLine($"TeamName: { teamname }| TeamFouls: { teamFouls } ");
            }
        ...
        public void CreateXlSheet(List<Team> Team)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < Team.Count; i++)
                {
                    ...
                    oSheet.Cells[row, 2] = Team[i].TeamFouls;
                }

                oXL.UserControl = false;
                oWB.SaveAs(@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\TeamFouls.xlsx", Microsoft.Office.Interop.Excel.XlFileFormat.xlWorkbookDefault, Type.Missing, Type.Missing,
                    false, false, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlNoChange,
                    Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
                oXL.Visible = true;

                string srcPath = (@"C:\Users\aditya.bhosle\Desktop\ISL\FTeamfoul.xls");

                oWB = (excel._Workbook)(oXL.Workbooks.Open(srcPath));
                oSheet = oWB.Worksheets.get_Item(1);

                string destPath = (@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\TeamFouls.xlsx");
