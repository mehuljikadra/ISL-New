...
namespace ISL
{
    class Saves
    {
        ...
        public Saves(IWebDriver driver)
        {
            this.driver = driver;
        }
        public IWebElement GetSavesData()
        {
            ...
            foreach (var div in allDivs)
            {
                ...
                var saves = div.FindElement(By.CssSelector(".si-plyStats-gamplyd ")).Text;

                players.Add(new players { Name = name, Id = id, Saves =saves });
                TestContext.Out.WriteLine($"NAME: { name }|Id:{id}| Saves: { saves } ");
            }
        ...
        public void CreateXlSheet(List<players> players)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < players.Count; i++)
                {
                    ...
                    oSheet.Cells[row, 3] = players[i].Saves;
                }

                oXL.UserControl = false;
                oWB.SaveAs(@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\Save.xlsx", Microsoft.Office.Interop.Excel.XlFileFormat.xlWorkbookDefault, Type.Missing, Type.Missing,
                    false, false, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlNoChange,
                    Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
                oXL.Visible = true;

                string srcPath = (@"C:\Users\aditya.bhosle\Desktop\ISL\Saves.xls");

                oWB = (excel._Workbook)(oXL.Workbooks.Open(srcPath));
                oSheet = oWB.Worksheets.get_Item(1);

                string destPath = (@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\Save.xlsx");
...

        {
            ...
            var saves = driver.FindElement(By.CssSelector(".si-points span")).Text;
