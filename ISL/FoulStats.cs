...
namespace ISL
{
    class FoulsStats
    {
        ...
        public FoulsStats(IWebDriver driver)
        {
            this.driver = driver;
        }
        public IWebElement GetFoulSheetData()
        {
            ...
            foreach (var div in allDivs)
            {
                ...
                var fouls1 = div.FindElement(By.CssSelector(".si-plyStats-gamplyd")).Text;

                players.Add(new players { Name = name, Id = id, Fouls = fouls1 });
                TestContext.Out.WriteLine($"NAME: { name }  | Id:{id}| Fouls: { fouls1 }");
            }
        ...
        public void CreateXlSheet(List<players> players)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < players.Count; i++)
                {
                    ...
                    oSheet.Cells[row, 3] = players[i].Fouls;
                }

                oXL.UserControl = false;
                oWB.SaveAs(@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\foulstats.xlsx", Microsoft.Office.Interop.Excel.XlFileFormat.xlWorkbookDefault, Type.Missing, Type.Missing,
                        false, false, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlNoChange,
                    Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
                oXL.Visible = true;

                string srcPath = (@"C:\Users\aditya.bhosle\Desktop\ISL\Foul.xls");

                oWB = (excel._Workbook)(oXL.Workbooks.Open(srcPath));
                oSheet = oWB.Worksheets.get_Item(1);

                string destPath = (@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\foulstats.xlsx");
...

        {
            ...
            var fouls1 = driver.FindElement(By.CssSelector(".si-points span")).Text;
