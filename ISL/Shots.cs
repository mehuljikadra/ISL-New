...
namespace ISL
{
    class Shots
    {
        ...
        public Shots(IWebDriver driver)
        {
            this.driver = driver;
        }
        public IWebElement GetShotsData()
        {
            ...
            foreach (var div in allDivs)
            {
                ...
                var shots = div.FindElement(By.CssSelector(".si-plyStats-gamplyd ")).Text;

                players.Add(new players { Name = name, Id = id, Shots = shots });
                TestContext.Out.WriteLine($"NAME: { name }| Id:{id}|Shots: { shots } ");
            }
        ...
        public void CreateXlSheet(List<players> players)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < players.Count; i++)
                {
                    ...
                    oSheet.Cells[row, 3] = players[i].Shots;
                }

                oXL.UserControl = false;
                oWB.SaveAs(@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\Shot.xlsx", Microsoft.Office.Interop.Excel.XlFileFormat.xlWorkbookDefault, Type.Missing, Type.Missing,
                    false, false, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlNoChange,
                    Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
                oXL.Visible = true;

                string srcPath = (@"C:\Users\aditya.bhosle\Desktop\ISL\Shots.xls");

                oWB = (excel._Workbook)(oXL.Workbooks.Open(srcPath));
                oSheet = oWB.Worksheets.get_Item(1);

                string destPath = (@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\Shot.xlsx");
...

        {
            ...
            var shots = driver.FindElement(By.CssSelector(".si-points span")).Text;
