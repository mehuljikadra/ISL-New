...
namespace ISL
{
    class Yellowcard
    {
        ...
        public Yellowcard(IWebDriver driver)
        {
            this.driver = driver;
        }
        public IWebElement GetYellowcardData()
        {
            ...
            foreach (var div in allDivs)
            {
                ...
                players.Add(new players { Name = name, Id = id, Yellowcard = yellowcard });
        ...
        public void CreateXlSheet(List<players> players)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < players.Count; i++)
                {
                    ...
                    oSheet.Cells[row, 3] = players[i].Yellowcard;
                }

                oXL.UserControl = false;
                oWB.SaveAs(@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\Yellowcards.xlsx", Microsoft.Office.Interop.Excel.XlFileFormat.xlWorkbookDefault, Type.Missing, Type.Missing,
                    false, false, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlNoChange,
                    Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
                oXL.Visible = true;

                string srcPath = (@"C:\Users\aditya.bhosle\Desktop\ISL\Yellowcard.xls");

                oWB = (excel._Workbook)(oXL.Workbooks.Open(srcPath));
                oSheet = oWB.Worksheets.get_Item(1);

                string destPath = (@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\Yellowcards.xlsx");
...

        {
            ...
            var yellowcard = driver.FindElement(By.CssSelector(".si-points span")).Text;
