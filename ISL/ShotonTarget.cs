...
namespace ISL
{
    class ShotonTarget
    {
        ...
        public ShotonTarget(IWebDriver driver)
        {
            this.driver = driver;
        }
        public IWebElement GetShotonTargetData()
        {
            ...
            foreach (var div in allDivs)
            {
                ...
                players.Add(new players { Name = name, Id = id, ShotonTarget = shotontarget });
        ...
        public void CreateXlSheet(List<players> players)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < players.Count; i++)
                {
                    ...
                    oSheet.Cells[row, 3] = players[i].ShotonTarget;
                }

                oXL.UserControl = false;
                oWB.SaveAs(@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\ShotonTarget.xlsx", Microsoft.Office.Interop.Excel.XlFileFormat.xlWorkbookDefault, Type.Missing, Type.Missing,
                    false, false, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlNoChange,
                    Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
                oXL.Visible = true;

                string srcPath = (@"C:\Users\aditya.bhosle\Desktop\ISL\Shotsontarget.xls");

                oWB = (excel._Workbook)(oXL.Workbooks.Open(srcPath));
                oSheet = oWB.Worksheets.get_Item(1);

                string destPath = (@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\ShotonTarget.xlsx");
...

        {
            ...
            var shotontarget = driver.FindElement(By.CssSelector(".si-points span")).Text;
