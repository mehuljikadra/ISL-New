...
namespace ISL
{
    class Assists
    {
        ...
        public Assists(IWebDriver driver)
        {
            this.driver = driver;
        }
        public IWebElement GetAssistsSheetData()
        {
            ...
            foreach (var div in allDivs)
            {
                ...
                var assists1 = div.FindElement(By.CssSelector(".si-plyStats-gamplyd span")).Text;

                players.Add(new players { Name = name, Id = id, Assists = assists1 });
                TestContext.Out.WriteLine($"NAME: { name }  |  Id:{id}|Assists: { assists1 }");
            }
        ...
        public void CreateXlSheet(List<players> players)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < players.Count; i++)
                {
                    ...
                    oSheet.Cells[row, 3] = players[i].Assists;
                }



                oXL.UserControl = false;
                oWB.SaveAs(@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\Assists.xlsx", Microsoft.Office.Interop.Excel.XlFileFormat.xlWorkbookDefault, Type.Missing, Type.Missing,
                            false, false, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlNoChange,
                    Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
                oXL.Visible = true;


                string srcPath = (@"C:\Users\aditya.bhosle\Desktop\ISL\Assist.xls");

                oWB = (excel._Workbook)(oXL.Workbooks.Open(srcPath));
                oSheet = oWB.Worksheets.get_Item(1);

                string destPath = (@"C:\Users\aditya.bhosle\source\repos\Data\Data\NewFolder1\Assists.xlsx");
...

        {
            ...
            var assists1 = driver.FindElement(By.CssSelector(".si-points span")).Text;
